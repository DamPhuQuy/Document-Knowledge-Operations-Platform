...
import { Avatar, Badge, Button, Drawer, Popover, Tag } from "antd";
import {
  Bell,
  Building2,
  ChevronRight,
...
interface MidoneLayoutProps {
  ...
  setActiveTab: (
    tab: "documents" | "organization" | "audit-logs" | "auth",
  ) => void;
...
export const MidoneLayout: React.FC<MidoneLayoutProps> = ({
  ...
  const { user, isAuthenticated, logout, isAdmin, isManager, isAuditor } =
    useAuth();
      ...
      <div style={{ maxHeight: 240, overflowY: "auto" }}>
        ...
        >
          ...
          <div style={{ color: "#64748b", fontSize: 12 }}>
            AES-GCM-256 and SHA-256 integrity checks enabled.
          </div>
        ...
        >
          <div style={{ fontWeight: 600, color: "#10b981" }}>
            Cluster Telemetry Synced
          </div>
          <div style={{ color: "#64748b", fontSize: 12 }}>
            Connected to API at {config.apiBaseUrl}
          </div>
          <div style={{ color: "#94a3b8", fontSize: 11, marginTop: 4 }}>
            5m ago
          </div>
        ...
        <div style={{ padding: "10px 12px", fontSize: 13 }}>
          <div style={{ fontWeight: 600, color: "#0f172a" }}>
            RBAC Department Enforced
          </div>
          <div style={{ color: "#64748b", fontSize: 12 }}>
            Access levels (PUBLIC, INTERNAL, CONFIDENTIAL, RESTRICTED) active.
          </div>
          <div style={{ color: "#94a3b8", fontSize: 11, marginTop: 4 }}>
            1h ago
          </div>
      ...
      {isAuthenticated && user ? (
        ...
        <div style={{ padding: 12, textAlign: "center" }}>
          <div style={{ fontSize: 13, color: "#64748b", marginBottom: 12 }}>
            You are operating in demo mode. Sign in to access full
    ...
    <>
      ...
      >
        <div className="midone-menu-item-left">
          <KeyRound size={18} />
          <span>
            {isAuthenticated ? "Identity & Session" : "Sign In / Register"}
          </span>
        </div>
        {isAuthenticated ? (
          <span
