...
public enum ErrorCode {
    ...
    DOMAIN_RULE_VIOLATION(HttpStatus.UNPROCESSABLE_ENTITY, "ERR_422_DOMAIN", "Business domain rule violation"),
    ...
    TICKET_NOT_FOUND(HttpStatus.NOT_FOUND, "ERR_TICKET_404", "Ticket not found"),
    TICKET_INVALID_STATE(HttpStatus.UNPROCESSABLE_ENTITY, "ERR_TICKET_STATE_422", "Invalid ticket state transition");
