        ...
        AssignUserDepartmentUseCase
{
    ...
    public DepartmentResponseDto createDepartment(
        ...
        log.info(
            "Created department [{}] with id [{}] by operator [{}]",
            saved.getCode(),
            saved.getId(),
    ...
    public DepartmentResponseDto updateDepartment(
        ...
        Department department = departmentRepositoryPort
        ...
        String validatedCode = Department.validateCode(command.code());
        if (
            departmentRepositoryPort.existsByCodeAndIdNot(
                validatedCode,
                command.departmentId()
            )
        ) {
        ...
        log.info(
            "Updated department [{}] ({}) by operator [{}]",
            updated.getCode(),
            updated.getId(),
            command.operatorUserId()
        );
    ...
    @Override
    @Transactional
    public UserDepartmentResponseDto assignUserDepartment(
        ...
        if (command.departmentId() != null) {
            department = departmentRepositoryPort
                .findById(command.departmentId())
                .orElseThrow(() ->
                    new DepartmentNotFoundException(
                        "Department not found: " + command.departmentId()
