...
public class RefreshToken {
    ...
    public RefreshToken(
        ...
        this.id = Objects.requireNonNull(
            id,
            "RefreshToken id must not be null"
        );
        this.userId = Objects.requireNonNull(
            userId,
            "RefreshToken userId must not be null"
        );
        this.token = Objects.requireNonNull(
            token,
            "RefreshToken token must not be null"
        );
        this.expiryDate = Objects.requireNonNull(
            expiryDate,
            "RefreshToken expiryDate must not be null"
        );
