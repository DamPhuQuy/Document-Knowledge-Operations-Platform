...
public class UserDepartmentController {
    ...
    public ResponseEntity<UserDepartmentResponseDto> assignDepartment(
        ...
        AssignUserDepartmentCommand command = new AssignUserDepartmentCommand(
            userId,
            request.departmentId(),
            request.isInternal(),
            operatorUserId
        ...
        UserDepartmentResponseDto response =
            assignUserDepartmentUseCase.assignUserDepartment(command);
        log.debug(
            "REST PUT /api/v1/users/{}/department completed for user [{}]",
            userId,
            response.userId()
        );
