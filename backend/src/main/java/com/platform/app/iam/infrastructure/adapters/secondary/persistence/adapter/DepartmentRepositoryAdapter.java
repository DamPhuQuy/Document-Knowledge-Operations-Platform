...
public class DepartmentRepositoryAdapter implements DepartmentRepositoryPort {
  ...
  public Department save(Department department) {
    ...
    DepartmentJpaEntity entity =
        springDataDepartmentRepository
  ...
  public boolean existsByCode(String code) {
    ...
    return springDataDepartmentRepository.existsByCodeIgnoreCase(code.trim());
  }
  ...
  public boolean existsByCodeAndIdNot(String code, UUID id) {
    ...
    return springDataDepartmentRepository.existsByCodeIgnoreCaseAndIdNot(code.trim(), id);
  }

  @Override
  @Transactional(readOnly = true)
  public List<Department> findAll() {
    return springDataDepartmentRepository.findAll().stream().map(this::toDomain).toList();
  }
