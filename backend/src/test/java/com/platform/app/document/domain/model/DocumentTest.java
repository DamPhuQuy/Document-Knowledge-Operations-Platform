...
class DocumentTest {
    ...
    @Test
    @DisplayName(
        "Should successfully create Document with valid attributes and default values"
    )
    ...
    @Test
    @DisplayName(
        "Should fallback to originalFileName if title is null or blank"
    )
    ...
    @Test
    @DisplayName(
        "Should reject file size exceeding 50MB with PayloadTooLargeException"
    )
    ...
    @Test
    @DisplayName(
        "Should initialize currentVersion to 1 by default and allow valid revision application"
    )
    void shouldApplyNewVersionSuccessfully() {
        ...
        doc.applyNewVersion(
            2,
            "documents/123/v2/report_v2.pdf",
            newSha256,
            2048L,
            "application/pdf",
            "report_v2.pdf"
    ...
    @Test
    @DisplayName(
        "Should reject applying new version with number not greater than current version"
    )
