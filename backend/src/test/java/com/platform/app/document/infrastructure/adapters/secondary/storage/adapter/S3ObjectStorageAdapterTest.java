...
class S3ObjectStorageAdapterTest {
  ...
  @Test
  @DisplayName("Should upload object to S3 with correct bucket, key and content type")
  ...
  @Test
  @DisplayName("Should wrap SdkException into StorageException when upload fails")
  ...
  @Test
  @DisplayName("Should wrap SdkException into StorageException when delete fails")
