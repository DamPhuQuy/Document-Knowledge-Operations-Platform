...
class DocumentAccessModelTest {
  ...
  @Test
  @DisplayName("Should reject DocumentUserAccess with null required attributes")
  void shouldRejectDocumentUserAccessWithNullAttributes() {
    UUID docId = UUID.randomUUID();
    UUID userId = UUID.randomUUID();

    assertThrows(NullPointerException.class, () ->
        new DocumentUserAccess(null, null, userId, PermissionLevel.VIEW, null));
    assertThrows(NullPointerException.class, () ->
        new DocumentUserAccess(null, docId, null, PermissionLevel.VIEW, null));
    assertThrows(NullPointerException.class, () ->
  ...
  void shouldUpdateDocumentAccessLevel() {
    ...
    assertThrows(NullPointerException.class, () -> doc.updateAccessLevel(null));
  }
}
