...
class AuditEventListenerTest {
  ...
  void shouldHandleDocumentAclUpdated() {
    ...
    DocumentAclUpdatedEvent event =
        DocumentAclUpdatedEvent.builder()
            .documentId(docId)
  ...
  void shouldHandleDocumentSoftDeleted() {
    ...
    DocumentSoftDeletedEvent event =
        DocumentSoftDeletedEvent.builder()
            .documentId(docId)
  ...
  void shouldHandleUserLoginFailed() {
    ...
    assertThat(cmd.getDetails()).containsEntry("reason", "Invalid credentials");
  }
  ...
  void shouldHandleUserRolesUpdated() {
    ...
    UserRolesUpdatedEvent event =
        new UserRolesUpdatedEvent(
            targetUserId, Set.of("STAFF"), Set.of("MANAGER"), operatorId, Instant.now());
