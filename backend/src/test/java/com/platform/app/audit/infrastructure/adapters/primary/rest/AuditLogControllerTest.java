...
class AuditLogControllerTest {
  ...
  @MockitoBean private GetAuditLogsUseCase getAuditLogsUseCase;
  @MockitoBean private com.platform.app.audit.application.ports.inbound.RecordAuditLogUseCase recordAuditLogUseCase;

  @Test
  @WithMockUser(roles = "ADMIN")
  @DisplayName("Should return 200 OK with audit logs when authenticated as ADMIN")
  ...
  @DisplayName("Should return 200 OK when authenticated with authority read:audit_logs")
  ...
  @DisplayName("Should return 403 Forbidden when authenticated user lacks audit authority")
  ...
  void shouldPassFiltersToUseCase() throws Exception {
    ...
    verify(getAuditLogsUseCase).getAuditLogs(filterCaptor.capture(), pageableCaptor.capture());
