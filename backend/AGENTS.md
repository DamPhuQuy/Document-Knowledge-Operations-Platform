...
<foundations>
  ...
  <pillar id="harness" title="Engineering Harness & Guardrails">
    ...
    <architecture_guardrail>
      Java 21+ Spring Boot. Hexagonal / Clean Architecture & Domain-Driven Design (DDD). Persistence entities, database tables, and external protocols must not leak into core domain models.
    </architecture_guardrail>
  </pillar>
</foundations>
